...
object TipRepository {
    val tips = listOf(
        Tip(
            ...
            verseRes = R.string.verse_1,
            verseTextRes = R.string.verse_text_1,
            imageRes = R.drawable._320
        ),
        Tip(
            ...
            verseTextRes = R.string.verse_text_3,
            imageRes = R.drawable.crocodile
        ),Tip(
            dayRes = R.string.day_4,
            verseRes = R.string.verse_4,
            verseTextRes = R.string.verse_text_4,
            imageRes = R.drawable.gray_wolf
        ),Tip(
            dayRes = R.string.day_5,
            verseRes = R.string.verse_5,
            verseTextRes = R.string.verse_text_5,
            imageRes = R.drawable.getstoredimage
        ),Tip(
            dayRes = R.string.day_6,
            verseRes = R.string.verse_6,
            verseTextRes = R.string.verse_text_6,
            imageRes = R.drawable._60_f_338622816_y8r5wqidfoe4aviy5ewfylv7cp49uenj
        ),Tip(
            dayRes = R.string.day_7,
            verseRes = R.string.verse_7,
            verseTextRes = R.string.verse_text_7,
            imageRes = R.drawable._6cli_lightning_mobilemasterat3x
        ),Tip(
            dayRes = R.string.day_8,
            verseRes = R.string.verse_8,
            verseTextRes = R.string.verse_text_8,
            imageRes = R.drawable.a01b997b_dd24_4e8d_a56b_7b3dd165f45b
        ),Tip(
            dayRes = R.string.day_9,
            verseRes = R.string.verse_9,
            verseTextRes = R.string.verse_text_9,
            imageRes = R.drawable.cellophane_bee_colletes_compactus
        ),Tip(
            dayRes = R.string.day_10,
            verseRes = R.string.verse_10,
            verseTextRes = R.string.verse_text_10,
            imageRes = R.drawable.d7b61a0c49f35d50827295d6e78e68b3
        ),Tip(
            dayRes = R.string.day_11,
            verseRes = R.string.verse_11,
            verseTextRes = R.string.verse_text_11,
            imageRes = R.drawable.grizzly_bear_
        ),Tip(
            dayRes = R.string.day_12,
            verseRes = R.string.verse_12,
            verseTextRes = R.string.verse_text_12,
            imageRes = R.drawable.istockphoto_1210318601_612x612
        ),Tip(
            ...
            verseTextRes = R.string.verse_text_14,
            imageRes = R.drawable.kyftm4zvgjhvten5gkjgopepxe
        ),Tip(
            dayRes = R.string.day_15,
            verseRes = R.string.verse_15,
